...
public class DBviewMediaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_view_media);
    }
    ...
    protected void onResume() {
        ...
        String[] select_column = { ObjectEntry.COLUMN_NAME, ObjectEntry.COLUMN_PATH_TO_SOUND, ObjectEntry.COLUMN_PATH_TO_VIDEO };
